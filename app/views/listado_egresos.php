...
<script>
    $(document).ready(function() {                
        $.ajax({
            url: './app/cgi/consulta_registros.php?tipo=E',
            dataType: 'JSON',
            success: function(rs) {
                if(rs.error==true){
                    ...
                    for (var i = 0; i < registros; i++) {
                        r=rs.datos[i];
                        negreso=r['rubro'];
                        nsubegreso=r['subrubro'];
                        registro = '<tr><td style="text-align: left;">'+egresos[negreso]+'</td><td style="text-align: left;">'+subEgresos[negreso][nsubegreso]+'</td><td style="text-align: left;">'+r['factura']+'</td><td style="text-align: center;">'+r['fecha']+'</td><td style="text-align: right;"><b>$ '+r['monto']+'</b></td><td style="text-align: left;"><font size=-1><i>'+r['detalle']+'</i></font></td></tr>';
    ...
    <div class="container">
        <div class="panel-body">
    		<h3>Listado de Egresos</h3><hr><br>
